...
//	Add Rating 
	@PostMapping("/project/addRating")
	public String CreateRating(@Valid @ModelAttribute("newRating") Rating rating,
			BindingResult results, Model projectModel) {
		if(results.hasErrors()) {
			return "projectDetails.jsp";
		}
		else {
			projectService.addRating(rating);
			return "redirect:/dashboard";
		}
